...
Nada más. El nombre de la huerta y el barrio **no se extraen aquí**: se le
preguntaron al principio, una por una, y ya están guardados. Si el mensaje
los menciona, ignórelos.
...
→ dos cultivos, tomate y cilantro, ambos en marzo del año correspondiente,
`fecha_imprecisa` false. El nombre de la huerta y el barrio se ignoran.

Mensaje: "tengo unas maticas de cebolla larga desde hace rato"
→ un cultivo "cebolla larga" con la fecha estimada y `fecha_imprecisa`
true.
